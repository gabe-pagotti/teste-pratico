<div>
    ...
    <form wire:submit="save">
        ...
        <div>
            ...
            <x-text-input wire:model="form.nome_fantasia" id="form.nome_fantasia" class="block mt-1 w-full" type="text" name="form.nome_fantasia" required autofocus value="{{ $form->unidade->nome_fantasia }}" />
        ...
        <div>
            ...
            <x-text-input wire:model="form.razao_social" id="form.razao_social" class="block mt-1 w-full" type="text" name="form.razao_social" required autofocus value="{{ $form->unidade->razao_social }}" />
        ...
        <div>
            ...
            <x-text-input wire:model="form.cnpj" id="form.cnpj" class="block mt-1 w-full" type="text" name="form.cnpj" required autofocus value="{{ $form->unidade->cnpj }}" />
